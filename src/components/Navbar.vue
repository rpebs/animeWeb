  ...
  <div class="navbar bg-base-100 shadow-xl">
    <div class="navbar-start">
      ...
      <div class="dropdown">
        ...
        <ul tabindex="0" class="menu menu-sm dropdown-content bg-base-100 rounded-box mt-3 w-64 p-2 shadow-lg">
          <li><router-link to="/">Home</router-link></li>
          <li>
            <details>
              <summary>Categories</summary>
              <ul class="p-2 bg-base-100 shadow-lg rounded-box mt-1">
                <li><router-link to="/category/adventure">Adventure</router-link></li>
    ...
    <div class="navbar-center hidden lg:flex">
      <ul class="menu menu-horizontal px-1">
        ...
        <li>
          <details>
            <summary>Categories</summary>
            <ul class="p-2 bg-base-100 shadow-lg rounded-box mt-1 w-64 z-50 absolute">
              <li><router-link to="/category/adventure">Adventure</router-link></li>
              <li><router-link to="/category/shounen">Shounen</router-link></li>
              <li><router-link to="/category/romance">Romance</router-link></li>
              <li><router-link to="/category/comedy">Comedy</router-link></li>
    ...
    <div class="navbar-end">
      <label class="swap swap-rotate">
        <input type="checkbox" class="theme-controller" v-model="isDarkTheme" value="" />
        <!-- Sun icon -->
